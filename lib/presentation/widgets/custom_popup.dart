...
class _PopupRoute extends PopupRoute<void> {
  ...
  void _calculateChildOffset(Rect? childRect) {
    ...
    if (customOffset != null) {
      // Sử dụng customOffset nếu được cung cấp
      _left = targetRect.left + customOffset!.dx;
      _top = targetRect.top + customOffset!.dy;
      _right = null;
      _bottom = null;
      _arrowDirection =
          _ArrowDirection.top; // Hoặc điều chỉnh tùy theo trường hợp
      _scaleAlignDx = 0.5;
      _scaleAlignDy = 0.5;
    } else {
